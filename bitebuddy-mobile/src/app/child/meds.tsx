        ...
        <View style={styles.scheduleCard}>
          ...
          <View style={styles.taskList}>
            <View style={styles.taskRow}>
              ...
              <View style={[styles.taskProgress, { backgroundColor: '#F59E0B' }]}><Text style={styles.taskProgressText}>Not Yet</Text></View>
            </View>
          </View>
        </View>
      </View>

      <Text style={styles.instruction}>Take a picture of your pills</Text>
      ...
      {imageUri ? (
        ...
        <View style={styles.previewWrapper}>
          ...
          <TouchableOpacity style={styles.feedBuddyBtn} onPress={takePicture}>
            ...
            <Text style={styles.feedBuddyText}>Confirm Meds!</Text>
          </TouchableOpacity>
        </View>
      )}
...
const styles = StyleSheet.create({
  ...
  topHeader: {
    ...
    width: '100%',
    height: 282, // A bit longer in Figma for meds
    position: 'absolute',
    top: 0,
    zIndex: 0,
  },
